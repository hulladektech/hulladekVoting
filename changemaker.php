...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <form id="msform" method="POST">
            <fieldset>
                <h2 class="fs-title">CHANGE MAKER OF THE QUARTER</h2>
...
;">Award Type</h2>
                <select id="ed" name="Award Type" required>
                    <option value="Change Maker">Change Maker</option>
                </select>
...
;">Employee Name</h2>
                <select id="se" name="Employee Name" required>
                    ...
                    <option value="Arjun Singh Gill">Arjun Singh Gill</option>
                    <option value="Arati Sharma">Arati Sharma</option>
                </select>
